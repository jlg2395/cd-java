...
public class Delfin extends Pez{
    ...
    public Delfin(int altura, int peso, int edad, String habitat, int numeroAletas, boolean escamas, String nombreCientifico, String nombre, String territorio, String sonido) {
